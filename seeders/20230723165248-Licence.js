...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Licences', [
      { Licence_Name: 'Licence 1', Start_Date: new Date(), End_Date: new Date(), IsActive: true, Enterprise_Allowed: true, Branch_Allowed: false, User_Allowed: true, Licence_TypeID: 1, Billing_Plan_LicenceID: 1, licenceJWT: 'jwt-token-licence-1', LicenceTypeID: 1, createdAt: new Date(), updatedAt: new Date() },
